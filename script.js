document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    if (isRequired && value === '') {
      ...
      const fieldName = label ? label.textContent.replace('*', '').trim() : (field.placeholder || 'This field');
      showError(field, customMessage || fieldName + ' is required.');
      return false;
    }
    ...
    if (VALIDATION_RULES[type]) {
      ...
      if (!rule.pattern.test(value)) {
        showError(field, customMessage || rule.message);
        return false;
      }
    }
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fetch(action, {
      ...
      .catch(function (err) {
        ...
        const errorMessage = form.getAttribute('data-error-fallback') || 'Something went wrong. Please try again.';
        let formErrorEl = form.querySelector('.form-error');
        if (!formErrorEl) {
  ...
  document.body.addEventListener('blur', function (e) {
    ...
    if (['INPUT', 'TEXTAREA', 'SELECT'].indexOf(field.tagName) === -1) return;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יגאל רויטמן שמאות רכוש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'b73c39fc-d12a-4741-8401-712d5c873f43',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'b73c39fc-d12a-4741-8401-712d5c873f43';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 055-9139983 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b73c39fc-d12a-4741-8401-712d5c873f43';
